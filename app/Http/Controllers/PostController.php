...
class PostController extends Controller
{
    ...
    {   
        ...
        if($boardTypeCode == 2 ){
            return view('posts.postIndex', compact('posts','boardNumber','boardName','comment','searchs','searchss','find','search','boardTypeCode','thumbnail'));
        }else{
            return view('posts.postIndex', compact('posts','boardNumber','boardName','comment','searchs','searchss','find','search','boardTypeCode'));
        }
    }
