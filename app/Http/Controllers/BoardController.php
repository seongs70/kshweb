...
class BoardController extends Controller
{
    ...
    public function show(\App\Board $board){
        ...
        return view('boards.boardShow', compact('board'));
    }
    ...
    {   
        ...
        return view('boards.boardEdit', compact('board'));
    }
    
    //게시 수정view에서 입력받은 데이터 처리
    public function update(Request $request, \App\Board $board)
    {   
        //데이터 수정처리
        $this->authorize('update', $board);
        ...
        return redirect(route('boards.show', $board->boardNumber));
    }
    
    //게시판 삭제
    public function destroy($boardNumber)
    {   
        $this->authorize('delete', $boardNumber);
        $boardNumber->delete();
